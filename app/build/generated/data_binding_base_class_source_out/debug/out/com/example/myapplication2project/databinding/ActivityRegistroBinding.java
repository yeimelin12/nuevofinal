...
public final class ActivityRegistroBinding implements ViewBinding {
  ...
  private ActivityRegistroBinding(@NonNull ConstraintLayout rootView, @NonNull EditText Password,
      @NonNull EditText emailadd, @NonNull Button register, @NonNull EditText reppassword,
  ...
  public static ActivityRegistroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.emailadd;
      EditText emailadd = ViewBindings.findChildViewById(rootView, id);
      if (emailadd == null) {
        break missingId;
      }
      ...
      return new ActivityRegistroBinding((ConstraintLayout) rootView, Password, emailadd, register,
          reppassword, textView, textView3, textView6, textView8);
    }
